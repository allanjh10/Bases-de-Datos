...
COMMENT ON CONSTRAINT persona_d4 ON persona IS 'El género debe ser H (hombre) o F (mujer)';
...
COMMENT ON CONSTRAINT animal_d5 ON animal IS 'El género debe ser H (hombre) o F (mujer)';
